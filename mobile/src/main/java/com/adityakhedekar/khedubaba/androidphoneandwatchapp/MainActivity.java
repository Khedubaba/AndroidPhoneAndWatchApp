package com.adityakhedekar.khedubaba.androidphoneandwatchapp;
        ...
        for (DataEvent event: dataEventBuffer){
            if (event.getType() == DataEvent.TYPE_CHANGED){
                ...
                if (item.getUri().getPath().compareTo("/data") == 0){
                    ...
                    //NOW ou can use variable friend wherever you want in order to display data on phone passed from wear device
                }
            }
        }
    }
